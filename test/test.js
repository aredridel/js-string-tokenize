...
import {tokenize1}                from '../lib/lib.js';
import {tokenize, nonDelimTokens} from '../lib/index.js';
    ...
    describe('two delimiters', function() {
        it('case 1', function() {
            ...
            for (let i = 0 ; i < searchPatterns.length ; i++) {
                const tokens: Array<TokenT> = tokenize('aba', searchPatterns[i]);
        ...
        it('case 1b', function() {
            const searchPatterns = [ ['a', 'b'], ['b', 'a'], ['x', 'xx', 'a', 'xxx', 'b'] ];
            for (let i = 0 ; i < searchPatterns.length ; i++) {
                const tokens: Array<TokenT> = tokenize('aba', searchPatterns[i], true, true);
        ...
        it('case 2', function() {
            const searchPatterns = [ ['a', 'b'], ['b', 'a'], ['x', 'xx', 'a', 'xxx', 'b'] ];
            for (let i = 0 ; i < searchPatterns.length ; i++) {
                const tokens: Array<TokenT> = tokenize('abccda', searchPatterns[i]);
        ...
        it('case 2b', function() {
            const searchPatterns = [ ['a', 'b'], ['b', 'a'], ['x', 'xx', 'a', 'xxx', 'b'] ];
            for (let i = 0 ; i < searchPatterns.length ; i++) {
                const tokens: Array<TokenT> = tokenize('abccda', searchPatterns[i], true, true);
        ...
        it('case 3', function() {
            const searchPatterns = [ ['a', 'b'], ['b', 'a'], ['x', 'xx', 'a', 'xxx', 'b'] ];
            for (let i = 0 ; i < searchPatterns.length ; i++) {
                const tokens: Array<TokenT> = tokenize(' f f abccda g', searchPatterns[i]);
        ...
        it('case 3b', function() {
            const searchPatterns = [ ['a', 'b'], ['b', 'a'], ['x', 'xx', 'a', 'xxx', 'b'] ];
            for (let i = 0 ; i < searchPatterns.length ; i++) {
                const tokens: Array<TokenT> = tokenize(' f f abccda g', searchPatterns[i], true, true);
        ...
        it('case 4', function() {
            ...
            for (let i = 0 ; i < searchPatterns.length ; i++) {
                const tokens: Array<TokenT> = tokenize('xxbaxx', searchPatterns[i]);
        ...
        it('case 4b', function() {
            const searchPatterns = [ ['a', 'ba'], ['ba', 'a'], ['y', 'yy', 'ba', 'yyy', 'a'] ];
            for (let i = 0 ; i < searchPatterns.length ; i++) {
                const tokens: Array<TokenT> = tokenize('xxbaxx', searchPatterns[i], true, true);
                assert.strictEqual(JSON.stringify(tokens), '[{"v":"xx","isDelim":false},{"v":"ba","isDelim":true},{"v":"xx","isDelim":false}]');
            }
        });                
        it('case 5', function() {
            const searchPatterns = [ ['a', 'ba'], ['ba', 'a'], ['y', 'yy', 'ba', 'yyy', 'a'] ];
            for (let i = 0 ; i < searchPatterns.length ; i++) {
                const tokens: Array<TokenT> = tokenize('xxbaabaxx', searchPatterns[i]);
        ...
        it('case 5b', function() {
            ...
            for (let i = 0 ; i < searchPatterns.length ; i++) {
                ...
                const tokens: Array<TokenT> = tokenize(INPUT, searchPatterns[i], true, true);
